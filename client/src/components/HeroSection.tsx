    ...
    >
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 items-center min-h-[calc(110vh-80px)] pt-20 pb-20">
            {/* Conteúdo textual */}
            <motion.div
              initial={{ opacity: 0, x: -30 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8 }}
              className="space-y-6 text-center lg:text-left flex flex-col h-full"
            >
              {/* Card principal do conteúdo */}
              <div className="bg-white/60 backdrop-blur-xl border border-white/40 rounded-3xl p-10 shadow-2xl shadow-rose-200/20 flex-1 flex flex-col justify-center">
                {/* Título principal */}
                ...
                {/* Linha decorativa */}
                <div className="w-24 h-1 bg-gradient-to-r from-rose-400 to-purple-400 rounded-full mx-auto lg:mx-0"></div>
              </div>
